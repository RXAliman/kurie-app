    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Your current bill for this period.',
          ...
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: KurieColors.primaryFixed.withAlpha(60),
                  borderRadius: BorderRadius.circular(4),
                ),
                child: Text(
                  'ACTIVE CYCLE',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _row(
            'You used 125 kWh of electricity this month.',
            Icons.electric_bolt_rounded,
          ),
          const SizedBox(height: 12),
          _row(
            'The current rate agreed upon is \u20B110.00 per kWh.',
          ...
          const SizedBox(height: 12),
          _row(
            'Your bill includes a \u20B1150 split base fee, plus 50 kWh at \u20B111.50/kWh.',
